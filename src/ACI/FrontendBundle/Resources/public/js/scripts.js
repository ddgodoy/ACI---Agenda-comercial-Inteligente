...
function removeMenuClasses() {
    $("#menu-apbwb li button").removeClass("active")
}
...
function downloadLayoutSrc() {
    ...
    t.find(".appt_container").addClass("removeClean");
    t.find(".box-element").addClass("removeClean");
    t.find(".appt_container .appt_container .appt_container .appt_container .appt_container .removeClean").each(function() {
        cleanHtml(this)
    });
    t.find(".appt_container .appt_container .appt_container .appt_container .removeClean").each(function() {
        cleanHtml(this)
    });
    t.find(".appt_container .appt_container .appt_container .removeClean").each(function() {
        cleanHtml(this)
    });
    t.find(".appt_container .appt_container .removeClean").each(function() {
        cleanHtml(this)
    });
    t.find(".appt_container .removeClean").each(function() {
        cleanHtml(this)
    });
...
$(document).ready(function() {
 ...
 /*   $(".demo, .demo .column").sortable({connectWith: ".column", opacity: .35, handle: ".drag"});
    $(".sidebar-nav .appt_container").draggable({connectToSortable: ".demo", helper: "clone", handle: ".drag", drag: function(e, t) {
            t.helper.width(400); 
        }, stop: function(e, t) {            
            $(".demo .column").sortable({opacity: .35, connectWith: ".column"})
        }});
    $(".sidebar-nav .box ,.cuadrante .box").draggable({connectToSortable: ".column", helper: "clone", handle: ".drag", drag: function(e, t) {
            t.helper.width(400);
            t.helper.css('background-color', '#ffffff');
            if(t.helper.hasClass('columna')) {
