...
class BackendController extends Controller {
    ...
    public function pricingAction() {
        ...
        return $this->render("FrontendBundle:Backend:pricing.html.twig", array("user_id" => $user_id));
    }
    ...
    public function builderAction() {
        ...
        $repo_site = $em->getRepository("FrontendBundle:Site");
        ...
        if ($page_id == null) {
            ...
            $repo_page = $em->getRepository("FrontendBundle:Page");
            $page = $repo_page->find($page_id);
            $sitio = $page->getSite();
        }


        $plugins = $em->getRepository("FrontendBundle:Plugin")->findAll();
    ...
    public function makeMenuAction() {
        ...
        return $this->render("FrontendBundle:Backend:menu.html.twig", array("links" => $menu));
    }
    ...
    public function selectWireframeAction() {
        ...
        return $this->render("FrontendBundle:Templates:$name.html.twig");
    }
    ...
    public function selectPageAction() {
        ...
        return $this->render("FrontendBundle:Backend:page_load.html.twig", array("page" => $page));
    }
    ...
    public function pageAction() {
        ...
        $repo_page = $em->getRepository("FrontendBundle:Page");
        $page = $repo_page->find($id);
        return $this->render("FrontendBundle:Backend:index.html.twig", array("page" => $page));
    }
    ...
    public function newPageAction() {
        ...
        $page = new \ACI\FrontendBundle\Entity\Page();
        $page->setHtml($this->renderView("FrontendBundle:Templates:$html.html.twig"));
        $page->setName($name);
        $page->setSeoDescription($description_seo);
        $page->setSeoKeywords($seoKeywords);
        $page->setSeoTitle($seoTitle);
        $page->setSlug($slug);
        $site = $em->getRepository("FrontendBundle:Site")->find($this->get('session')->get('site_id'));
        $page->setSite($site);
...
//     else
        $page->setEditHtml($this->renderView("FrontendBundle:Templates:blank.html.twig"));
    ...
    public function updatePageAction() {
        ...
        $em = $this->getDoctrine()->getManager();
        $page = $em->getRepository("FrontendBundle:Page")->find($id);
        if ($page == null) {
            $name = $request->get('name', 'page');
            $page = new \ACI\FrontendBundle\Entity\Page();
            $page->setName($name);
    ...
    public function pageTreeAction() {
        ...
        $pages = $em->getRepository("FrontendBundle:Page")->findBySite($site_id);
    ...
    public function pageListAction() {
        $em = $this->getDoctrine()->getManager();
        $site_id = $this->get('session')->get('site_id');
        $site = $em->getRepository("FrontendBundle:Site")->find($site_id);
        return $this->render("FrontendBundle:Backend:page_list.html.twig", array("site" => $site));
    }
    ...
    public function deletePageAction(Request $request) {
        $em = $this->getDoctrine()->getManager();
        $id = $request->get('id');
        $entity = $em->getRepository('FrontendBundle:Page')->find($id);
        $result = array();
