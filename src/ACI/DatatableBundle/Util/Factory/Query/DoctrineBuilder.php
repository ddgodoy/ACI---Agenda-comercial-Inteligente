...
namespace ACI\DatatableBundle\Util\Factory\Query;
    ...
    protected function _addSearch(\Doctrine\ORM\QueryBuilder $queryBuilder)
    {
        ...
        {   
            ...
            foreach ($search_fields as $i => $search_field)
            {
                ...
                }else{ //Rachid (agregando code para que filtre general también)
                    $search = $request->get("sSearch");
                    if($search!="")
                        $queryBuilder->OrWhere(" $search_field like '%{$search}%' ");
                }
            }
