...
namespace ACI\DatatableBundle\Util;

use Symfony\Component\DependencyInjection\ContainerInterface,
    Symfony\Component\HttpFoundation\Response;
use Doctrine\ORM\Query,
    Doctrine\ORM\Query\Expr\Join;
use ACI\DatatableBundle\Util\Factory\Query\DoctrineBuilder,
    ACI\DatatableBundle\Util\Formatter\Renderer,
    ACI\DatatableBundle\Util\Factory\Prototype\PrototypeBuilder ;
...
class Datatable
{
    ...
    /** @var \ACI\DatatableBundle\Util\Factory\Query\QueryInterface */
    ...
    /** @var array */
    protected $permisos = array("OWNER");
    ...
    /*
     * Nueva funcionalidad integrada a las ACLs 
     */
    public function setAcl($permisos) {
        $this->permisos = $permisos;
        $this->queryBuilder->setPermisos($permisos);
        return $this;
    }
    ...
    public function execute($hydration_mode = Query::HYDRATE_ARRAY)
    {
        ...
        foreach ($data as $key=>$value) {
            $value['DT_RowId']=$data[$key][count($data[$key])-1];
            $data2[]=$value;
        }
     ...
     *       ->setEntity("GETBaseBundle:Entity", "e")
     *       ->setFields($fields)
     ...
     *                               ->get('templating')
     *                               ->render('GETBaseBundle:Entity:_decorator.html.twig',
     *                                       array(
     *                                           'data' => $value
     *                                       )
     *                               );
     ...
     *          array(
     *             2 => array(
     *               'view' => 'GETDatatableBundle:Renderers:_actions.html.twig',
     *               'params' => array(
