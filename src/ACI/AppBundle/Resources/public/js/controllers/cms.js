define(["jquery", "jqueryclean", "jquery_ui", "intro", "transition"], function($, jqueryclean, jquery_ui, introJs, transition) {
    ...
    $("[data-nombre='animacion'],[data-nombre='borde'],[data-nombre='color']").draggable({
        helper: "clone",
        handle: ".drag, .preview",
        drag: function(e, t) {
            //t.helper.width(400);
    ...
    $('.logoEstatico').click(function() {
        if (flag) {
            ...
            $('#extra-opts').children().css('right', '-6px');
           ...
           // $("body").removeClass("edit");
            ...
            $('#extra-opts').children().css('right', '-184px');
